	...
	run: function()
	{
		for(var i in Game.flags)
		{
			if(Game.flags[i].name.toLowerCase().startsWith('claim'))
			{
				...
				if(Game.rooms[spawnRoomName] && Game.rooms[spawnRoomName].controller && Game.rooms[spawnRoomName].controller.my)
				{
					...
					if(normalSpawn)
					{
						...
						}else if(Game.rooms[claimRoomName] && Game.rooms[claimRoomName].controller && Game.rooms[claimRoomName].controller.my && Game.rooms[claimRoomName].controller.level < 4)
						{
